                        ...
                        <tbody class="bg-white text-dark">
                            ...
                            <tr id="<?= $isi['barkas_id'];?>" gambar="<?= $isi['barkas_gambar'];?>">
                                ...
                                <td style="width: 100px;" class="pl-4">
                                    <a href="<?= base_url('/aktivasi/'.$isi['barkas_id']) ?>" class="btn btn-sm btn-outline-secondary">Aktivasi</a>
                                    <a href="#" data-href="<?= base_url('/batal-barkas/'.$isi['barkas_id']) ?>" onclick="confirmToDelete(this)" class="btn btn-sm btn-outline-danger">Batal</a>
                                </td>
                            </tr>
                            <?php 
                                endforeach;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="#" role="button" id="delete-button" class="btn btn-danger">Batalkan Pendaftaran</a>
